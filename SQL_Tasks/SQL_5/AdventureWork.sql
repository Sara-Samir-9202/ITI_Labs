...
IF OBJECT_ID('store_Archive', 'U') IS NOT NULL
...
--12.	12.Using union statement, retrieve the today’s date in different styles using convert or format funtion.
